...
There is no data protection law yet. But the personal data protection bill is under discussion in Parliament House (see \cite{pdp}). To anticipate its ratification, the system should comply with its basic recommendations: 
\begin{itemize}
	\item identify sensitive data
	\item control data movement
	\item respect the least-privilege principle
\end{itemize}
Users should also be able to delete their personal data if they don't use DREAM anymore. In that case, their production data could be used anonymously for statistical purposes.

To access to geo-tracking functionalities, the system should ask the user.
