...
The system should be reliable as it's goal is to be the main instrument for farmers. Policy maker will also rely on the system to provide true data on the farmers to improve the general performance in the state.
\subsubsection{Availability}
The system should be available all the time with a real necessity around the end and the beginning of a season. The end because the farmers will have to put their data, the policy makers will watch the results and questions may be ask at this moment to improve the next season.
\subsubsection{Security}
Data should be secured, DREAM will only collect the data that are needed for the good working of the system. Users will have the right to delete their data. 
Security 
\subsubsection{Maintainability}
As a used application it will have to maintained, this will need peoples available for the app.
But also during the definition and building of the app, an effort has to be putted on the global maintainability.
\subsubsection{Portability}
Dream should be available for every farmer of the state and therefore available on all platforms. The goal is that farmers have a system that helps them.
